 ...
 */
public class Parent_Teacher_List_From_New_Post_Activity extends Activity implements View.OnClickListener {
    ...
    Parent_teacher_List_for_new_post_Adapter parent_teacher_list_for_new_post_adapter = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (str_selected_class_name.equalsIgnoreCase("") || str_selected_class_name.length() == 0) {
            ...
            if (sharedPreferencesClass.getSelected_Language().equalsIgnoreCase(Common.Selected_Language_AR)) {
                tv_subtitle.setText(Common.filter("lbl_class", "ar") + " - " + str_selected_class_name);

            } else {
                tv_subtitle.setText(Common.filter("lbl_class", "en") + " - " + str_selected_class_name);
    ...
    private void GetFieldArray() {
        try {
            ...
            if (jsonArraysuccess != null) {
                ...
                parent_teacher_list_for_new_post_adapter = new Parent_teacher_List_for_new_post_Adapter(context, getParentsDetailsForParticularClassid_newPostArrayList);
                lv_list.setAdapter(parent_teacher_list_for_new_post_adapter);
                parent_teacher_list_for_new_post_adapter.notifyDataSetChanged();

                parent_teacher_list_for_new_post_adapter.setTheListener(new Parent_teacher_List_for_new_post_Adapter.TheListener() {
                    @Override
                    public void somethingHappened() {

//                        Toast.makeText(Parent_Teacher_List_From_New_Post_Activity.this, "Call Interface ====> ", Toast.LENGTH_SHORT).show();
...
//                tv_selected.setText("Selected " + count + "");
