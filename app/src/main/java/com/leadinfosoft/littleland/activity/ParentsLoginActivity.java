...
public class ParentsLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharedPreferencesClass.getSelected_Language().equalsIgnoreCase(Common.Selected_Language_AR)) {
            setContentView(R.layout.activity_parents_login_new_ar);

        } else {
            setContentView(R.layout.activity_parents_login_new);
    ...
    private void setTypeface_Text() {
        ...
        if (sharedPreferencesClass.getSelected_Language().equalsIgnoreCase(Common.Selected_Language_AR)) {
            ...
            et_techid.setHint(Common.filter("lbl_parent_id", "ar").toUpperCase());
            ...
            et_techid.setHint(Common.filter("lbl_parent_id", "en").toUpperCase());
   ...
   /* @OnClick(R.id.tv_signin)
    ...
    private void ParentsLoginWebservice() {
        if (isValid()) {
...
//                            Toast.makeText(context, jsonObject.optString("success"), Toast.LENGTH_SHORT).show();
                            ...
                            Intent i = new Intent(ParentsLoginActivity.this, MainActivity.class);
//                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            ...
            if (con.isConnectingToInternet()) {
                req = new RequestMaker(resp, params, ParentsLoginActivity.this);
    ...
    private boolean isValid() {
        ...
        if (str_et_techid.equalsIgnoreCase("") || str_et_techid.length() == 0) {
            ...
            if (sharedPreferencesClass.getSelected_Language().equalsIgnoreCase(Common.Selected_Language_AR)) {
                et_techid.setError(Common.filter("error_Please_Enter_Parents_Id", "ar"));

            } else {
                et_techid.setError(Common.filter("error_Please_Enter_Parents_Id", "en"));
